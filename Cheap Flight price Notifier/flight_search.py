...
## first try for flights with zero stopover
## if flight with zero stop overs is not available,... go for flights with 1 stop over... if still not available, return no flights (None)
